...
method="post"
	action="{{ URL::to('/admin/ip-binding/create') }}">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" name="MacAddress" data-parsley-trigger="change" required placeholder="Enter Mac Address" class="form-control" id="MacAddress" value="@isset($mac){{$mac->MacAddress}}@endisset"/>
    </div>
