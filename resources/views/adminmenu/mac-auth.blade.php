...
@section('title', 'Mac Address Authentication')
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
    <div class="card mb-3">
        <div class="card-header">
            <h3><i class="fa fa-table"></i>Create Wifi Account Authentication By Mac Address</h3>
            <div class="pull-right">
                    <div class="pull-right">                            
                            <a role="button" class="btn btn-primary fancybox" data-fancybox data-type="iframe" data-src="/admin/mac-auth/create" href="javascript:;"><span class="btn-label"><i class="fa fa-check"></i></span>New Device</a>
                    </div>
                </div>
        </div>
